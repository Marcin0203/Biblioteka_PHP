<?php
    ...
    require_once 'userLogin.php';                   //Dołączenie klasy reprezentującej użytkownika podczas logowania
     ...
     $_SESSION['dodaj_ksiazke_process'] = "";       //utworzenie zmiennej sesyjne dajacej dostep do dołączenia pliku dodaj_ksiazke_process.php
    require_once 'dodaj_ksiazke_process.php';       //Dołączenie pliku dodaj_ksiazke_process.php
