<?php
    ...
    require_once 'userLogin.php';                   //Dołączenie klasy reprezentującej użytkownika podczas logowania
     ...
     $_SESSION['moje_ksiazki_process'] = "";        //utworzenie zmiennej sesyjne dajacej dostep do dołączenia pliku moje_ksiazki_process.php
    require_once 'moje_ksiazki_process.php';        //Dołączenie pliku moje_ksiazki_process.php
